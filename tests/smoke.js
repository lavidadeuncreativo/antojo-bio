...
assert(cleanApp.includes("const STORE='antojo_clean_state_v2'"), 'Existe persistencia local de la nueva versión');
...
assert(cleanApp.includes("'cold-brew':'americano'"), 'Cold brew tiene fallback visual estable');
